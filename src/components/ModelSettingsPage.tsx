...
const copy = {
  zh: {
    ...
    codexBoundary: "公开静态网站不能直接调用你的个人 Codex 套餐，也不会自动启动 Codex。点击生成后，网站会把任务写入项目目录；你再在 Codex 中执行该任务。",
  ...
  en: {
    ...
    codexBoundary: "A public static site cannot directly consume your personal Codex plan or start Codex. Generation writes a task into the project folder for you to run in Codex.",
